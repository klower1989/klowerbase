...
public class ResideMenu extends FrameLayout {
	...
	public void setLeftMenuView(int id) {
		setLeftMenuView(LayoutInflater.from(mContext).inflate(id, null));
	}
	...
	public void setRightMenuView(int id) {
		setRightMenuView(LayoutInflater.from(mContext).inflate(id, null));
	}
