...
public class SideBar extends View {
    ...
    public void setCanChoose(boolean isChoose){
    	isCanTouch = isChoose;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < b.length; i++) {
            paint.setColor(Color.parseColor("#ED6D00"));
            // paint.setColor(Color.WHITE);
            paint.setTypeface(Typeface.DEFAULT_BOLD);
            paint.setAntiAlias(true);
            paint.setTextSize(Utils.getDPValue(getContext(), 16));
//            paint.setTextSize((int)(Utils.getDensity((Activity) getContext())*(25)));
...
//                setBackgroundDrawable(new ColorDrawable(0x00000000));
                ...
                if (listener != null && c >= 0 && c < b.length) {
