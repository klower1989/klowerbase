package com.klower.velocimeter;
 ...
 */
public class ProgressVelocimeterPainterImp implements
	...
	public ProgressVelocimeterPainterImp(int color, float max, int margin,
			Context context) {
		this.color = color;
		this.max = max;
	...
	private void initPainter() {
		...
		paint.setPathEffect(new DashPathEffect(new float[] { lineWidth,
				lineSpace }, 0));
	}
