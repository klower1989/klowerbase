 ...
 *         LogTool.i(&quot;onProgressUpdate(values)&quot; + values[0]);
 *     }
 *
 *     &#064;Override
 *     public void onSuccess(Long result) {
 *         super.onSuccess(result);
 *         LogTool.i(&quot;onSuccess(result)&quot; + result);
 *     }
 *
 *     &#064;Override
...
public abstract class AsyncTask<Params, Progress, Result> extends
    ...
    public static void setDefaultExecutor(Executor executor) {
        ...
        try {
            ...
            e.printStackTrace();
            LogTool.e("IllegalArgumentException", e);
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
            LogTool.e("ClassNotFoundException", e);
        } catch (NoSuchFieldException e) {
            e.printStackTrace();
            LogTool.e("NoSuchFieldException", e);
        } catch (IllegalAccessException e) {
            e.printStackTrace();
            LogTool.e("IllegalAccessException", e);
        }
    }
