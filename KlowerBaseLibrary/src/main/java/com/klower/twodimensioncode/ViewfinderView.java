...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			int lineHeight = (int) (Utils.getDensity((Activity)mContext)*15);

			canvas.drawRect(15 + frame.left, 15 + frame.top,
					15 + (linewidht + frame.left), 15 + (lineHeight + frame.top), paint);
			canvas.drawRect(15 + frame.left, 15 + frame.top,
					15 + (lineHeight + frame.left), 15 + (linewidht + frame.top), paint);
			
			
			canvas.drawRect(-15 + ((0 - linewidht) + frame.right),
					15 + frame.top, -15 + (1 + frame.right),
					15 + (lineHeight + frame.top), paint);
			canvas.drawRect(-15 + (-lineHeight + frame.right), 15 + frame.top, -15
					+ frame.right, 15 + (linewidht + frame.top), paint);
			canvas.drawRect(15 + frame.left, -15 + (-lineHeight + frame.bottom),
					15 + (linewidht + frame.left), -15 + (1 + frame.bottom),
					paint);
			canvas.drawRect(15 + frame.left, -15
					+ ((0 - linewidht) + frame.bottom), 15 + (lineHeight + frame.left),
					-15 + (1 + frame.bottom), paint);
			canvas.drawRect(-15 + ((0 - linewidht) + frame.right), -15
					+ (-lineHeight + frame.bottom), -15 + (1 + frame.right), -15
					+ (1 + frame.bottom), paint);
			canvas.drawRect(-15 + (-lineHeight + frame.right), -15
