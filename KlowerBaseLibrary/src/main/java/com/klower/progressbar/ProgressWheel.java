package com.klower.progressbar;
...
public class ProgressWheel extends View {
	...
	private void parseAttributes(TypedArray a) {
		...
		textSize = (int) a.getDimension(R.styleable.ProgressWheel_wheel_textSize, textSize);

		textColor = (int) a.getColor(R.styleable.ProgressWheel_wheel_textColor, textColor);
