...
import com.klower.flatui.FlatButton;
import com.klower.flatui.FlatCheckBox;
import com.klower.flatui.FlatEditText;
import com.klower.flatui.FlatRadioButton;
import com.klower.flatui.FlatSeekBar;
import com.klower.flatui.FlatTextView;
import com.klower.flatui.FlatToggleButton;
import com.klower.flatui.FlatUI;
...
public class FlatUIActivity extends ActionBarActivity {
	...
	protected void onCreateEqually(Bundle savedInstanceState)
		...
		setCustomContentView(R.layout.flatui);

		findViewById(R.id.shapetextview).setOnClickListener(
				new OnClickListener() {
		...
		findViewById(R.id.shapetextview1).setOnClickListener(
				new OnClickListener() {
		...
		// getSupportActionBar().setBackgroundDrawable(FlatUI.getActionBarDrawable(this,
		// APP_THEME, false, 2));
		...
		flatTextViews
				.add((FlatTextView) findViewById(R.id.title_buttons_touch_effect));
		...
		/**
		 * This part is an example of spinner usage. You can change the theme of
		 * this spinner by editing the layout files spinner_button and
		 * simple_flat_list_item.
		 */
		...
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(
				this, R.array.themes_array, R.layout.spinner_button);
		...
		/**
		 * Autocomplete textview. You can change the EditText color via theme
		 * but you need to set a layout for the rows as shown below. This is the
		 * same row that is used in the spinner example.
		 */
		AutoCompleteTextView actv = (AutoCompleteTextView) findViewById(R.id.autoCompleteTextView1);

		String[] themes = getResources().getStringArray(R.array.themes_array);
		ArrayAdapter acAdapter = new ArrayAdapter(this,
				R.layout.simple_flat_list_item, themes);
	...
	private void changeTheme(int colorReference) {
		...
		// this
		// getActionBar().setBackgroundDrawable(FlatUI.getActionBarDrawable(this,
