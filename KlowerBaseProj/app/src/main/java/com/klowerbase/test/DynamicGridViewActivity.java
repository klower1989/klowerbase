...
import com.klower.dynamicgrid.DynamicGridView;
import com.klower.titlebar.BaseException;
import com.klowerbase.test.adapter.CheeseDynamicAdapter;
...
public class DynamicGridViewActivity extends ActionBarActivity {
	...
	protected void onCreateEqually(Bundle savedInstanceState)
		...
		setCustomContentView(R.layout.dynamicgrid);
		gridView = (DynamicGridView) findViewById(R.id.dynamic_grid);
		gridView.setAdapter(new CheeseDynamicAdapter(this,
				new ArrayList<String>(Arrays.asList(sCheeseStrings)), 3));
		...
		gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
					int position, long id) {
				Toast.makeText(DynamicGridViewActivity.this,
	...
	public final String[] sCheeseStrings = { "Abbaye de Belloc",
