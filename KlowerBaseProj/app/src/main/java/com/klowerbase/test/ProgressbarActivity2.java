...
import com.klower.progressbar2.IconRoundCornerProgressBar;
import com.klower.progressbar2.RoundCornerProgressBar;
import com.klower.progressbar2.TextRoundCornerProgressBar;
import com.klower.titlebar.BaseException;

public class ProgressbarActivity2 extends ActionBarActivity implements
	...
	protected void onCreateEqually(Bundle savedInstanceState)
		...
		setCustomContentView(R.layout.progressbar2);
		...
		progressOne.setHeaderColor(getResources().getColor(
				R.color.custom_progress_blue_header));
		progressOne.setBackgroundColor(getResources().getColor(
		...
		progressTwo.setBackgroundColor(getResources().getColor(
				R.color.custom_progress_background));
	...
	public void onClick(View v) {
		...
		case R.id.button_progress_one_increase:
			progress1 = (progress1 < progressOne.getMax()) ? progress1 + 1
					: progress1;
			updateProgressOne();
			break;
		...
		case R.id.button_progress_two_increase:
			progress2 = (progress2 < progressTwo.getMax()) ? progress2 + 1
					: progress2;
			updateProgressTwo();
			break;
		}
